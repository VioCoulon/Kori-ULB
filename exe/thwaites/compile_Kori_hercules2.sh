...
path_param=$path_exe/$REMOTE_HOST/stoch/tau_To_70/$exp      # Stochastic.
...
path_cluster=/globalsc/ulb/glaciol/dmoreno/Kori-ULB/exe/stoch/tau_To_70/
...
file=RunASE_hercules.m
exe_name=RunASE_hercules
