function run_pseudo_transient
    ...
    path_1      = [parent_path, 'output/pseudo-transient/spinup/'];
    path_2      = [parent_path, 'output/pseudo-transient/spinup/'];

    
    init_name = 'ThuleIn5';             % INIT_SSA_3
    out_name  = 'PT_spinup';            % deter_gamma1e-2
    input     = strcat(path_1, init_name);
    output    = strcat(path_2, out_name);

    
    save(input,'B','H','Mb','Ts','LSF');
