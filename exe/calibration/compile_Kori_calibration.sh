...
# LOCAL PATHS.
path_m=$path_kori/calibration
path_exe=$path_kori/exe/calibration      # CalvingMIP.
...
file_name=KoriCalibration.m
exe_name=KoriCalibration_$exp

echo "Compiling    : $file_name"
echo "Exe_name     : $exe_name"
#echo "path_cluster : $path_cluster"

# Copy matlab file for compilation.
cp $path_m/$file_name .
