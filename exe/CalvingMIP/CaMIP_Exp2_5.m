...
ctr.nsteps=1000;     % Daniel 500 (just to test re-advance), 1000; Jim: 10000
ctr.timeslice=1;
ctr.LSFReset=1000;
...
%KoriModel('Exp2_5_pseudo-transient_H-frank_retreat','Exp2_5_pseudo-transient_H-frank_advance',ctr);
