function [H, Hn] = IceShelfContinuity(ctr, row, col, H, Hn, glMASK)
    ...
    % This algorithm systematically looks for adjacent points and ensures ice thickness
    % continuity along the growth direction of the ice shelf.
    % The idea is consistent with the concept that the difference between calving rate and 
    % front velocity gives the ice shelf terminus migration. 
