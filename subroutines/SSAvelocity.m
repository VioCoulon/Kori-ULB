...
% Iterative solution to the SSA velocity (both pure SSA and hybrid model
    ...
    if cnt < cnt_init
        ...
        end % End viscosity loop.
    
    % Pseudo-transient solver.
    else
        [uxs1,uys1,eta,dudx,dvdy,dudy,dvdx,k,err]=SolverSSA_pseudo_transient(nodeu,nodev, ...
                su,MASKmx,MASKmy,bMASK,H,uxssa,uyssa,...
                uxsia,uysia,udx,udy,taudx,taudy,MASK,glMASK,Asf,cnt,A,shelftune,ctr,par);
    end
